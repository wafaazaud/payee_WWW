    ...
    public partial class EditPayee : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DL.ExecuteCommand("update_Payee", param);
                MessageBox.Show("تم تعديل بيانات المنتفع بنجاح", "تأكيد", MessageBoxButtons.OK, MessageBoxIcon.Information);
                DL.Close();
            }
            catch { return; };
        }

        private void EditPayee_Load(object sender, EventArgs e)
        {
            loadcomboclass();
        }
    }
